...
(function() {
  module.exports = (function(x) {
      ...
      if (this.fs.existsSync(f)) {
        ...
        add = (function(_this) {
          return function(heading, rule) {
            ...
            expandVars = function(x) {
              var match, n, y, z, zz, _i, _j, _len, _len1, _ref;
              y = [];
              for (_i = 0, _len = x.length; _i < _len; _i++) {
                z = x[_i];
                if ((match = /^[$][(]([^)]*)[)]$/.exec(z)) != null) {
        ...
        this.error("File '" + f + "' does not exist!");
      }
      return this;
    },
    error: function(msg) {
    ...
    performAction: function() {
      var firstTarget, k, v, x, _i, _len, _ref, _ref1;
