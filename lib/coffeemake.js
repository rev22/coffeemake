...
(function() {
  ...
  module.exports = (function(x) {
    ...
    sh: function() {
      var args, cmd, cmdparts, k, opt, t, v, x, _i, _len;
      args = (function() {
        var _i, _len, _results;
        _results = [];
        for (_i = 0, _len = arguments.length; _i < _len; _i++) {
    ...
    setupMakefile: function(f) {
      var add, c, heading, line, lineno, match, rule, _i, _len, _ref,
        _this = this;
    ...
    options: {
      ...
      f: function(args) {
        ...
        return ((_ref = this.makefiles) != null ? _ref : this.makefiles = []).push(args.shift());
      }
    },
    ...
    watchAction: function() {
      ...
      timeout = null;
      this.buildAction();
      this.fs.watch('.', function(event, filename) {
    ...
    tryBuild: function(target, deps, task, soft) {
      var fileDidExistBefore, xx, _i, _len;
    ...
    withProcessArgs: function(cb) {
      ...
      argv = process.argv;
      args = /([/]|^)coffee([.]exe)?$/i.test(argv[0]) ? argv.slice(1) : argv.slice(0);
      progname = args.shift();
      cb.call(this, args, {
        progname: progname
      });
    ...
    runWithArgs: function(args) {
      ...
      return this.processOptions(args).performAction();
    },
    runStandalone: function(_arg) {
      ...
      return this.withProcessArgs(this.runWithArgs);
    },
    runIfStandalone: function() {
      this.withProcessArgs(function(args, _arg) {
        var progname;
        progname = _arg.progname;
